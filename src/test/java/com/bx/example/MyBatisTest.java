...
import com.bx.example.domain.associate.AuthorAndBlog;
import com.bx.example.domain.associate.BlogAndAuthor;
import com.bx.example.domain.associate.BlogAndComment;
import com.bx.example.mapper.BlogMapper;
import com.bx.example.mapper.BlogMapperExt;
...
public class MyBatisTest {
    ...
    public void testStatement() throws IOException {
        ...
        try {
            Blog blog = (Blog) session.selectOne("com.bx.example.mapper.BlogMapper.selectBlogById", 1);
